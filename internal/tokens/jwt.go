...
func (m *Manager) GenerateAccessToken(userID int32, username string) (string, error) {
	claims := Claims{
		UserID:   userID,
		Username: username,
...
func (m *Manager) GenerateRefreshToken(userID int32, username string) (string, error) {
	claims := Claims{
		UserID:   userID,
		Username: username,
		RegisteredClaims: jwt.RegisteredClaims{
